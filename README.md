...
you should see a *Whitelabel Error Page*. This behaviour is expected since this template has no routes defined. You will now add a simple welcoming page in place of the previously seen error page.
